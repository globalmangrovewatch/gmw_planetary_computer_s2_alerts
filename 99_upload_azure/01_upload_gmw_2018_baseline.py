...
gmw_tif_tiles = glob.glob("/home/jovyan/PlanetaryComputerExamples/gmw_alerts_plantary_computer_tests/gmw_2018_ext_tiles/*.tif")

for img_file in tqdm.tqdm(gmw_tif_tiles):
    basename = os.path.basename(img_file)
    file_url = os.path.join(sas_token_info["url"], "gmw_2018_baseline", basename)
