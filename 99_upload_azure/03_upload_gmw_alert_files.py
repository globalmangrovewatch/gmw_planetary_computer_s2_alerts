...
gmw_tif_tiles = glob.glob("/home/jovyan/PlanetaryComputerExamples/gmw_alerts_plantary_computer_tests/monthly_change_imgs_v8/*.tif")

for img_file in tqdm.tqdm(gmw_tif_tiles):
    basename = os.path.basename(img_file)
    file_url = os.path.join(sas_token_info["url"], "monthly_change_imgs", basename)
